...
function fn_search_keyword() {
  ...
  var keyword_filter = keyword_input.value.toUpperCase();
  var content_desc = document.getElementsByClassName("content_desc");
  for (let i = 0; i < content_desc.length; i++) {
   var txtValue = content_desc[i].textContent || content_desc[i].innerText;
    if (txtValue.toUpperCase().indexOf(keyword_filter) > -1) {
